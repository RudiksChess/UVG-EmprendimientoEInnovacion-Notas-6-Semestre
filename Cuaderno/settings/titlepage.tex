...
\textsc{\Large CU177 - 2 semestre - 2021}\\[0.8cm]
\MSonehalfspacing
\textsc{Licenciatura en matemática aplicada}\\[1.0cm]

\HRule\\[1.4cm]
\MSdoublespacing
{ \huge \bfseries EMPRENDIMIENTO E INNOVACIÓN}\\[0.2cm]
{ \large Catedrático: Julio Martínez}\\[0.3cm] % Falls nicht benötigt, einfach auskommentieren
\HRule \\[2.4cm]
\MSonehalfspacing
